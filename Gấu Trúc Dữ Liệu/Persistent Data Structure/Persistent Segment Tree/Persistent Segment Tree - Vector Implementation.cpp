// Persistent Segment tree - Vector Imple
/* documents
...
struct per_segtree 
{
    struct Node
    {
        ...
        Node(ll tmp,int L, int R) : val(tmp), l(L), r(R) {} 
    };
    
    vector<int> root;
    vector<Node> nodes;
    
    int ver_cnt,treeL,treeR; // version counters, tree boundaries
